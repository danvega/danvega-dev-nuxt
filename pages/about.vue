...
useHead({
  title: 'Nidhal Naffati - About Me',
  meta: [
    { name: 'title', content: 'Nidhal Naffati - About Me' },
    { name: 'description', content: 'Hello 👋🏻 My Name is Nidhal Naffati' }
  ]
});
</script>
    ...
    <div class="grid grid-cols-1 gap-y-16 lg:grid-cols-2 lg:grid-rows-[auto_1fr] lg:gap-y-12">
      ...
      <div class="lg:pl-20">
        <div class="max-w-xs px-2.5 lg:max-w-none">
          <NuxtImg
            src="/images/nidhal_portrait.jpg"
      ...
      <div class="lg:order-first lg:row-span-2">
        <h1 class="text-4xl font-bold tracking-tight text-zinc-800 dark:text-zinc-100 sm:text-5xl">
          <TypedText :typed="['Hello 👋🏻',' My Name is Nidhal']"/>
        </h1>
      ...
      <div class="lg:pl-20">
        <ul role="list">
          <li class="mt-4 flex">
            <a class="group flex text-sm font-medium text-zinc-800 transition hover:text-blue-500 dark:text-zinc-200 dark:hover:text-blue-500" href="https://www.linkedin.com/in/nidhal-naffati" target="_blank">
          ...
          <li class="mt-4 flex">
            <a class="group flex text-sm font-medium text-zinc-800 transition hover:text-blue-500 dark:text-zinc-200 dark:hover:text-blue-500" href="https://github.com/NidhalNaffati" target="_blank">
              <svg viewBox="0 0 24 24" aria-hidden="true" class="h-6 w-6 flex-none fill-zinc-500 transition group-hover:fill-blue-500">
          ...
          <li class="mt-8 border-t border-zinc-100 pt-8 dark:border-zinc-700/40 flex">
            <a class="group flex text-sm font-medium text-zinc-800 transition hover:text-blue-500 dark:text-zinc-200 dark:hover:text-blue-500" href="mailto:danvega@gmail.com">
              ...
              <span class="ml-4">nidhalnaffati@gmail.com</span>
            </a>
          </li>
        </ul>
      </div>
