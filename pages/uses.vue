...
useHead({
  title: 'Dan Vega - Uses',
  meta: [
    { name: 'title', content: 'Dan Vega - Uses' },
    { name: 'description', content: 'Hardware & Software I use, gadgets I love, and other things I recommend.' }
  ]
});
</script>
        ...
        <section aria-labelledby=":S3:" class="md:border-l md:border-zinc-100 md:pl-6 md:dark:border-zinc-700/40">
          <div class="grid max-w-3xl grid-cols-1 items-baseline gap-y-8 md:grid-cols-4">
            ...
            <div class="md:col-span-3">
              <ul role="list" class="space-y-16">
                <li class="group relative flex flex-col items-start">
                  <a href="https://amzn.to/3F5XnG8">
                    <h3 class="text-base font-semibold tracking-tight text-zinc-800 dark:text-zinc-100">Sony A6100</h3>
                  </a>
                  <p class="relative z-10 mt-2 text-sm text-zinc-600 dark:text-zinc-400">The Sony A6100 has become my go-to gear for creating stunning YouTube videos. Its ability to shoot in sharp 4K resolution ensures that every detail is captured crisply, making my content visually engaging. Moreover, the ease of use and reliable autofocus system lets me focus more on the content creation rather than fiddling with camera settings, making my filming process smooth and efficient.</p>
                </li>
                <li class="group relative flex flex-col items-start">
                ...
                <li class="group relative flex flex-col items-start">
                  ...
                  <p class="relative z-10 mt-2 text-sm text-zinc-600 dark:text-zinc-400">Epidemic Sound has been a treasure trove of high-quality soundtracks that add a unique vibe to each of my videos. Its vast library and user-friendly interface make finding the perfect tune a breeze, ensuring my content is always sonically engaging and complementary to the visual narrative.</p>
                </li>
                <li class="group relative flex flex-col items-start">
                  <a href="https://www.ecamm.com/">
                    <h3 class="text-base font-semibold tracking-tight text-zinc-800 dark:text-zinc-100">Ecamm Live</h3>
                  </a>
                  <p class="relative z-10 mt-2 text-sm text-zinc-600 dark:text-zinc-400">Ecamm Live has revolutionized the way I record screencasts and go live on YouTube, offering a seamless, user-friendly interface coupled with robust functionality. The software provides a smooth recording and streaming experience, ensuring high-quality output that engages my audience whether I'm sharing my screen or interacting live, making every session professional and enjoyable.</p>
                </li>
              </ul>
            </div>
          </div>
